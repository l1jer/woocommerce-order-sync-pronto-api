            ...
            <div class="wcospa-settings-section">
                ...
                <div class="wcospa-log-stats">
                    ...
                    <ul>
                        ...
                        <li><?php _e('General log:', 'wcospa'); ?> <code>logs/wcospa-YYYY-MM-DD.log</code></li>
                        <li><?php _e('Order logs:', 'wcospa'); ?> <code>logs/order-{order_id}.log</code> (<?php _e('flat — no subdirectories', 'wcospa'); ?>)</li>
                    </ul>
                </div>
            </div>
